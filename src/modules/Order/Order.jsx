...
export const Order = () => {
  ...
  const closeModal = (e) => {
    ...
    if (
      (targetElem && targetElem?.matches(`.${style.order}`)) ||
      targetElem.closest(`.${style.close}`)
    ) {
  ...
  return (
    <>
      <div className={style.order} onClick={closeModal}>
            ...
            <>
              ...
              <form className={style.form} id="order">
                ...
                <fieldset className={style.fieldset}>
                  ...
                  <div className={style.input["input-group"]}>
                    <input
                      className={style.input}
                      type="text"
                      name="name-recipient"
